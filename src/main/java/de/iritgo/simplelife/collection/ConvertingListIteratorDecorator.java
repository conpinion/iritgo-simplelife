...
/**
 * A decorator for ListIterators that converts between the real type of the
 * iterated elements and a another type.
 * 
 * @param <RealType> The real type of the iterated elements
 * @param <ConvertedType> The converted type
 */
public class ConvertingListIteratorDecorator<RealType, ConvertedType> implements ListIterator<ConvertedType>
{
	/** The decorated iterator */
	private ListIterator<RealType> iterator;
